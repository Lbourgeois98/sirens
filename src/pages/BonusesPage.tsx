  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto mb-16">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-slate-800/90 to-teal-900/90 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border-2 border-yellow-400/30">
            ...
            <div className="grid sm:grid-cols-2 gap-6 text-sm sm:text-base text-cyan-200">
              <div className="space-y-3">
                <p>• 50% signup bonus on first deposit</p>
                <p>• 50% referral bonus (max cashout 5x deposit)</p>
                <p>• Minimum deposit: $10, Maximum: $500</p>
                <p>• Minimum cashout: 3x deposit + bonus</p>
              </div>
              <div className="space-y-3">
                <p>• Maximum cashout: 8x deposit</p>
                <p>• All cashouts must be claimed within 12 hours</p>
